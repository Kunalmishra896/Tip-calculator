...
const inputPersonAmount = document.getElementById("Number_of_people");
const inputsRadio = document.querySelectorAll(".tip input");
const resetBtn = document.getElementById("reset");
const form = document.querySelector("form");
const personTipAmount = document.getElementById("person_tip_amount");
const total = document.getElementById("total");
const inputCustomTip = document.getElementById("input_custom_butt");
